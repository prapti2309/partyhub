...
export const registerPlayerHandlers = (io: Server, socket: Socket<any, any, any, SocketData>) => {
  ...
  socket.on(SOCKET_EVENTS.PLAYER_PLAY, async (payload: any, ack: any) => {
  ...
  socket.on(SOCKET_EVENTS.PLAYER_PAUSE, async (payload: any, ack: any) => {
    await withErrorHandling(async (_socket, data, ackFn) => {
  ...
  socket.on(SOCKET_EVENTS.PLAYER_SEEK, async (payload: any, ack: any) => {
    await withErrorHandling(async (_socket, data, ackFn) => {
  ...
  socket.on(SOCKET_EVENTS.PLAYER_SYNC, async (payload: any, ack: any) => {
    await withErrorHandling(async (_socket, data, ackFn) => {
